...
namespace Tests.RepoTests
{
    internal sealed class RepoUrlHelper_GetRepoAbsoluteUrl_Tests
    {
        ...
        public void Should_Return_Null_If_Null_Url()
        {
            ...
            string? url = repoUrlHelper.GetRepoAbsoluteUrl(null, RepoPaths.Create("https://github.com/owner/repo", "main", "/readme.md")!, false);
        ...
        {
            var repoUrlHelper = new RepoUrlHelper();
            string? url = repoUrlHelper.GetRepoAbsoluteUrl(absoluteUrl, RepoPaths.Create("https://github.com/owner/repo", "main", "/readme.md")!, false);
            Assert.That(url, Is.Null);
        }
        ...
        {
            var repoUrlHelper = new RepoUrlHelper();
            string? url = repoUrlHelper.GetRepoAbsoluteUrl("/reporelative.md", RepoPaths.Create("https://github.com/owner/repo", "main", "/docs/readme.md")!, false);
        ...
        {
            var repoUrlHelper = new RepoUrlHelper();
            string? url = repoUrlHelper.GetRepoAbsoluteUrl(relativeUrl, RepoPaths.Create("https://github.com/owner/repo", "main", "/docs/readme.md")!, false);
